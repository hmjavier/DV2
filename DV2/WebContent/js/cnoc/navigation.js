			...
			callback : function(response, divContainers, divElements) {
				...
				$.each(menu, function( index, value ) {
	        		if(value === "gen=true"){
	        			...
	        			divElements[1].append("<li><a href='pages/changesCalendar.html'><i class='fa fa-fw fa-calendar'></i> Changes Calendar </a></li>");
	            		
	        		}else if(value === "advSearch=true"){        			
	        			divElements[1].append("<li><a href='pages/search.html'><i class='fa fa-fw fa-search'></i> Advanced Search </a></li>");
	        		}
	        	});
